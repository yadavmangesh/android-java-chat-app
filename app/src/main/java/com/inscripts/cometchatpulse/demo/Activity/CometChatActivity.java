...
public class CometChatActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        Log.d(TAG, "onResume: ");
        cometChatActivityPresenter.addMessageListener(CometChatActivity.this, getString(R.string.message_listener));
    ...
    protected void onPause() {
        ...
        cometChatActivityPresenter.removeMessageListener(getString(R.string.message_listener));
